...
public class BuffFallScript : MonoBehaviour
{
    ...
    private GameObject[] goodPrefabs;
    ...
    void Start()
    {
        goodPrefabs = new GameObject[] { gemPrefab,  pizzaPrefab,donutPrefab };
    ...
    void SpawnGem()
    {
        ...
        */
        ...
        GameObject randomPrefab = goodPrefabs[randomIndex];
